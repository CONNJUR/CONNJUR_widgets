...
${OBJECTDIR}/_ext/f944c5bd/connjur.o: /home/nmrbox/mgryk/CONNJUR_spike/lib/connjur.c
	${MKDIR} -p ${OBJECTDIR}/_ext/f944c5bd
	${RM} "$@.d"
	$(COMPILE.c) -g `pkg-config --cflags libxml-2.0` `pkg-config --cflags gtk+-3.0` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f944c5bd/connjur.o /home/nmrbox/mgryk/CONNJUR_spike/lib/connjur.c
