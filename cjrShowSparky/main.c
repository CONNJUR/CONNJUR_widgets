 ...
 *  main
 * 
 *  This program expects one filename argument: namely a Sparky (.ucsf) file
 ...
 *  If the sparky header is invalid, an error Dialog is displayed.
 */

int main(int argc, char** argv) {

    sparkyHeaderStruct *sparkyHeader;
    char sparkyOverall[256], sparkyDimensions[256];
    GtkBuilder *builder;
    GtkWidget *window, *sparkyLabel1, *sparkyLabel2;
    int i;
    GError *error = NULL;
    ...
    sparkyLabel1 = GTK_WIDGET(gtk_builder_get_object(builder, "sparkyLabel1"));
    sparkyLabel2 = GTK_WIDGET(gtk_builder_get_object(builder, "sparkyLabel2"));
